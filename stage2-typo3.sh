...
sudo mysql -e "CREATE DATABASE typo3demo"
sudo mysql -e "CREATE USER 'typo3demo'@'%' IDENTIFIED BY '123456'"
sudo mysql -e "GRANT ALL PRIVILEGES ON typo3demo.* TO 'typo3demo'@'%'"
...
TYPO3_DB_DATABASE="typo3demo"
TYPO3_DB_HOST="localhost"
TYPO3_DB_PASSWORD="123456"
TYPO3_DB_SOCKET=""
TYPO3_DB_USERNAME="typo3demo"
EOF
